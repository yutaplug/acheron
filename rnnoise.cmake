if(ENABLE_VOICE AND ENABLE_RNNOISE)
    ...
    if(NOT TARGET rnnoise)
        ...
        if(PkgConfig_FOUND)
            pkg_check_modules(RNNOISE_PC QUIET IMPORTED_TARGET rnnoise)
            if(TARGET PkgConfig::RNNOISE_PC)
                add_library(rnnoise INTERFACE)
                target_link_libraries(rnnoise INTERFACE PkgConfig::RNNOISE_PC)
            endif()
        endif()
    endif()
    if(TARGET rnnoise)
        message(STATUS "Using system rnnoise")
        return()
    endif()
    if(rnnoise_FOUND)
